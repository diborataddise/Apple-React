...
class Body extends Component {
	...
	return(
		<div>
			...
			<section className="top-section top-50">
	...
	<section className="huleteg-hightlight-wrapper">
		<div className="container">
	...
	<section className="sosetga-hightlight-wrapper">
		<div className="container">
	...
	<section className="aratga-heghlight-wrapper">
	...
	<section className="amestga-heghlight-wrapper">
		<div className="container-fluid">
			<div className="row">
				<div className="left-side-wrapper col-sm-12 col-md-6">
					<div className="left-side-container">
	...
	<section className="sedestga-heghlight-wrapper">
		<div className="container-fluid">
			<div className="row">
				<div className="left-side-wrapper col-sm-12 col-md-6">
					<div className="left-side-container">
